                    ...
                    <div className="relative group cursor-pointer h-1/2">
                        <div className="relative h-full rounded-xl overflow-hidden shadow-lg">
                            ...
                            <div className="absolute bottom-3 left-3 text-white opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                <p className="text-sm font-medium drop-shadow-lg">{images[1].name}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex gap-4 h-1/2">
                        <div className="relative group cursor-pointer w-1/2">
                            <div className="relative h-full rounded-xl overflow-hidden shadow-lg">
                                ...
                                <div className="absolute inset-0 bg-gradient-to-t from-black/30 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                                <div className="absolute bottom-3 left-3 text-white opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                    <p className="text-sm font-medium drop-shadow-lg">{images[2].name}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="relative group cursor-pointer w-1/2">
                            <div className="relative h-full rounded-xl overflow-hidden shadow-lg">
                                ...
                                <div className="absolute inset-0 bg-gradient-to-t from-black/30 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                                <div className="absolute bottom-3 left-3 text-white opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                    <p className="text-sm font-medium drop-shadow-lg">{images[3].name}</p>
                                </div>
                            </div>
                        </div>
                    </div>
