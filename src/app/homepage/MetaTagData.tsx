...
const MetaTagData = () => {
    // Single CMS content block parsed from the Fatafat Sewa image
    const cmsContent = `
...
&lt;link rel='canonical' href='https://fatafatsewa.com/'&gt;</code></pre>
  ...
  `;
    ...
    const previewContent = cmsContent.slice(0, 450) + "...";
    ...
    return (
        <div className="bg-white w-full max-w-8xl mx-auto p-6 rounded-lg shadow-sm">
            <div
                ...
                dangerouslySetInnerHTML={{ __html: isExpanded ? cmsContent : previewContent }}
            />
            <button
