...
interface ReletdProductsProps {
    title?: string;
    items: CategorySlug[];
}

const ReletdProducts = ({ title, items }: ReletdProductsProps) => {
                    ...
                    {Datalist.map((product, index) => (
                        <div
                            ...
                            className={cn(
                                ...
                                // Desktop: each item takes ~20% width (5 items visible)
