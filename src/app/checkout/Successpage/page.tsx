...
import { Check, Package, CreditCard, MapPin, Mail, Phone, PersonStanding, User, MapPinHouse, PackageOpen, Store } from 'lucide-react';
...
export default function OrderConfirmation() {
    ...
    return (
        <div className="min-h-screen  p-3 sm:p-4">
            <div className="max-w-7xl mx-auto bg-white/80 backdrop-blur-sm rounded-2xl shadow-2xl p-5 sm:p-6 border border-white/20">
                <div className="grid lg:grid-cols-5 gap-3 sm:gap-6 ">
                    {/* Left Column */}
                    <div className="lg:col-span-2 ">
                        {/* Success Icon */}
                        <div className="flex justify-center mb-4">
                            <div className="w-16 h-16 bg-gradient-to-br from-emerald-400 via-green-500 to-teal-500 rounded-full flex items-center justify-center shadow-lg ">
                                <Check className="w-10 h-10 text-white" strokeWidth={3} />
                            </div>
                        </div>

                        {/* Thank You Message */}
                        <h1 className="text-xl sm:text-2xl font-black text-transparent bg-clip-text bg-[var(--colour-fsP2)]  mb-2 text-center leading-tight">
                        ...
                        {/* Billing Address */}
                        <div className="bg-gradient-to-br from-gray-50/50 to-gray-100/50 backdrop-blur rounded-xl p-4 mb-4 border border-gray-200/50">
                            <h2 className="text-lg font-bold text-[var(--colour-fsP2)] mb-3 flex items-center">
                                <MapPin className="w-5 h-5 mr-2 text-[var(--colour-fsP1)]" />
                                Billing Address
                            </h2>
                            ...
                            <div className="space-y-2 text-sm">
                                <div className="flex items-start">
                                    ...
                                    <span className="font-semibold text-gray-700 w-16 shrink-0">Name</span>
                                    <span className="text-gray-900">{billingInfo.name}</span>
                                </div>

                                <div className="flex items-start">
                                    <MapPinHouse className="w-3.5 h-3.5 mr-1.5 text-gray-500" />
                                    <span className="font-semibold text-gray-700 w-16 shrink-0">Address</span>
                                    <span className="text-gray-900 leading-snug">{billingInfo.address}</span>
                                </div>

                                <div className="flex items-center">
                                    <Phone className="w-3.5 h-3.5 mr-1.5 text-gray-500" />
                                    <span className="font-semibold text-gray-700 w-14 shrink-0">Phone</span>
                                    <span className="text-gray-900">{billingInfo.phone}</span>
                                </div>

                                <div className="flex items-center">
                                    <Mail className="w-3.5 h-3.5 mr-1.5 text-gray-500" />
                                    <span className="font-semibold text-gray-700 w-14 shrink-0">Email</span>
                        ...
                        <div className='flex flex-row justify-between gap-2 w-full'>
                            ...
                            className="w-fit px-4 bg-[var(--colour-fsP2)] text-white font-bold py-3 rounded-lg shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-[1.02] flex items-center justify-center text-sm">
                                <PackageOpen className="w-4 h-4 mr-2 text-[var(--colour-fsP1)] " fill='white' strokeWidth={1} />
                                Track Your Order
                            </button>
                            <button
                             onClick={()=>handlerouter('/')}
                             className="w-fit px-4 bg-[var(--colour-fsP2)] text-white font-bold py-3 rounded-lg shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-[1.02] flex items-center justify-center text-sm">
                                <Store className="w-4 h-4 mr-2 text-[var(--colour-fsP1)] " fill='white' strokeWidth={1}/>
                                Continue to Shoping
                            </button>
                        </div>
                    </div>
                    ...
                    <div className="lg:col-span-3 ">
                        <h2 className="text-2xl sm:text-2xl font-black text-[var(--colour-fsP2)] mb-4">Order Summary</h2>
                ...
                <p className="text-[var(--colour-fsP1)] text-center pt-2 text-sm leading-relaxed">
                    If you have Any Problem and need to Know More Contact to our Service Number
                </p>
            </div>
        </div>
    )
