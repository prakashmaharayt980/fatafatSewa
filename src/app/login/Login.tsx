...
const LoginPage = () => {
  ...
  // For "from", you may want to use search params or a custom solution in Next.js
  const from = '/';
  ...
  const handleGoogleLogin = async (credentialResponse: any) => {
    ...
    //  const address ='https://backendshop-oy2c.onrender.com/api/' 
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <Link href="/" className="flex justify-center items-center text-2xl font-bold text-brand-blue">
...
// GoogleLoginButton type
type GoogleLoginButtonProps = {
  onGoogleLogin: (credentialResponse: any) => void;
  isLoading: boolean;
};

// Dummy GoogleLoginButton for placeholder (replace with actual implementation if available)
const GoogleLoginButton: React.FC<GoogleLoginButtonProps> = ({ onGoogleLogin, isLoading }) => (
  <button
    type="button"
    className="w-full mt-4 bg-blue-500 text-white py-2 rounded hover:bg-blue-600"
    disabled={isLoading}
    onClick={() => onGoogleLogin({ credential: 'dummy-google-token' })}
  >
