...
const RenderReview: React.FC<RenderReviewProps> = ({
  ...
  return (
    <div className="max-w-4xl mx-auto bg-white shadow-xl border border-gray-200 flex flex-col min-h-screen">
      <div className="p-4 sm:p-6 flex-grow">
                  ...
                  {files.citizenshipFile?.ppphoto ? (
                    ...
                    <div className="w-full h-full flex items-center justify-center bg-gray-50">
                      <Image
                        ...
                        width={32}
                        height={32}
                        className="h-16 w-16 sm:h-24 sm:w-24 text-[var(--colour-fsP2)]/60"
                      />
                    </div>
                  )}
                </div>
                <p className="text-xs text-gray-500 mt-2">Photo</p>
              </div>
            </div>
            ...
            <div className="col-span-1 sm:col-span-4">
              <div className="flex items-center gap-2 mb-4">
                <Image
                  ...
                  width={24}
                  height={24}
                  className="h-6 w-6 text-[var(--colour-fsP2)]/60"
                />
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {personalInfoFields.map((field, index) => (
                  <div key={index} className={field.label === "Address" ? "sm:col-span-2" : ""}>
                    ...
                    <dd className="text-sm font-medium text-gray-900 border-b border-gray-300 pb-1">{field.value}</dd>
                  </div>
                ))}
              </div>
            </div>
              ...
              <div className="col-span-1 sm:col-span-4">
                <div className="flex items-center gap-2 mb-4">
                  <Image
                    ...
                    className="h-6 w-6 text-[var(--colour-fsP2)]/60"
                  />
                  <h2 className="text-lg sm:text-xl font-bold text-gray-900">Credit Card Information</h2>
                </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    {creditCardFields.map((field, index) => (
                      <div key={index} className={field.label === "Credit Limit" ? "sm:col-span-2" : ""}>
                        <dt className="text-xs font-medium text-gray-600 uppercase">{field.label}</dt>
                        <dd className="text-sm font-medium text-gray-900 border-b border-dotted border-gray-300 pb-1">{field.value}</dd>
                      </div>
                    ))}
                  </div>
                </div>
              ...
              <div className="col-span-1 sm:col-span-4">
                <div className="flex items-center gap-2 mb-1">
                  <Image
                    ...
                    className="h-6 w-6 text-[var(--colour-fsP2)]/60"
                  />
                  <h2 className="text-lg sm:text-xl font-bold text-gray-900">Banking Information</h2>
                </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-5   gap-4">
              <div className="col-span-1 order-1 sm:order-2 flex justify-center sm:justify-start">
                <div className="flex flex-col items-center">
                  ...
                  <p className="text-xs text-gray-500 mt-2">Guarantor</p>
                </div>
              </div>
              <div className="col-span-1 sm:col-span-4 order-2 sm:order-1">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h2 className="text-lg sm:text-xl font-bold text-gray-900">Guarantor Information</h2>
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className={`col-span-1  ${(hasCreditCard === "no") ? 'sm:col-span-5 ' : "sm:col-span-4 "}`}>
              <div className="flex items-center gap-2 mb-4">
                <Image
                  ...
                  className="h-6 w-6 text-[var(--colour-fsP2)]/60"
                />
                <h2 className="text-lg sm:text-xl font-bold text-gray-900">EMI Calculation Details</h2>
              </div>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                  {emiFields.map((field, index) => (
                    <div key={index} className="text-center">
                      <dt className="text-xs font-medium text-gray-600 uppercase">{field.label}</dt>
                      <dd className="text-sm font-medium text-gray-900  border-gray-300 pb-1">{field.value}</dd>
                    </div>
                  ))}
                </div>
              </div>
        ...
        <section className="mb-6 border-b border-gray-200 pb-6 grid grid-cols-1 sm:grid-cols-5 gap-4">
          ...
          <div className={`col-span-1  ${(hasCreditCard === "no") ? 'sm:col-span-5 ' : "sm:col-span-4 "}`}>
            ...
            {hasCreditCard === "no" && (
              <div className="mt-6">
                <h3 className="text-sm font-semibold text-gray-700 mb-4">Guarantor Documents</h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        ...
        <section className="mb-6">
          <div className="grid grid-cols-1 sm:grid-cols-5 gap-2">
            <div className="col-span-4">
              <h3 className="text-sm font-semibold text-gray-800 mb-2">Declaration</h3>
            ...
            <div className="text-center  sm:col-span-1">
              ...
              <div className="relative group inline-block cursor-pointer">
                <input
                  ...
                  className="hidden"
                />
                <div className="border border-dashed border-gray-300 rounded p-1 bg-gray-50 w-32 h-16 flex items-center justify-center">
                  {files.userSignature ? (
                    <div className="relative">
                      ...
                      <div className="absolute inset-0 flex items-center justify-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity bg-black/10 rounded">
                        ...
                        <Button
                          ...
                          className="cursor-pointer text-red-600 p-1"
                        >
                          <Trash size={12} />
                        </Button>
                      </div>
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center gap-4 pt-4 border-t border-gray-200">
          <Button
            ...
            className="w-full sm:w-auto px-4 py-2 text-gray-600 border-gray-300 hover:bg-gray-50 text-sm"
          >
            Back to Edit
          </Button>
          <Button
            ...
            className="w-full sm:w-auto px-6 py-2 bg-green-900 text-white hover:bg-[var(--colour-fsP2)] font-medium text-sm"
          >
            Submit Application
          </Button>
        </div>
      ...
      <div className="bg-gray-100 border-t border-gray-200 p-3 text-center text-xs text-gray-600">
