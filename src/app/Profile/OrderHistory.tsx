import { Ban, Check, CreditCard, Loader, PackageCheck, ShoppingBasket, ThumbsUp, Trash, Undo } from 'lucide-react'
                    ...
                    <div key={order.id} className="bg-white border rounded-2xl border-gray-200 p-3 hover:border-gray-300 transition-colors">
                        ...
                        <div className="mt-2 flex gap-3 justify-end">
                            ...
                            <button
                                ...
                                className="flex gap-2 items-center flex-row rounded-2xl px-3 py-1 bg-[var(--colour-fsP2)] text-white hover:bg-[var(--colour-fsP1)]  transition-colors text-sm font-medium">
